...
class SellerVerificationOverviewValidationTest extends TestCase
{
    use RefreshDatabase;

    public function test_seller_verification_accepts_short_non_empty_company_overview(): void
    {
        Storage::fake('public');
        ...
        $this->assertSame('Marine spare parts and service support.', $seller->company_overview);
        $this->assertSame('Marine spare parts and service support.', $seller->company_description);
    }
}
