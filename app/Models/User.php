...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    protected function casts(): array
    {
        return [
            ...
            'seller_verification_ai_review' => 'array',
            'seller_verification_ai_reviewed_at' => 'datetime',
            'seller_verification_onboarding_sent_at' => 'datetime',
            'seller_verification_24h_reminder_sent_at' => 'datetime',
            'seller_verification_72h_reminder_sent_at' => 'datetime',
